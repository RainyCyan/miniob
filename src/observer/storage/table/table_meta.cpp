...
// by ywm,remove index from indexes
RC TableMeta::remove_index(const IndexMeta &index_meta)
{
  // indexes_.erase(std::remove(indexes_.begin(), indexes_.end(), index_meta), indexes_.end());
