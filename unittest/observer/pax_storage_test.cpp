...
TEST_P(PaxRecordFileScannerWithParam, DISABLED_test_file_iterator)
{
  ...
  Chunk     chunk;
  FieldMeta fm;
  fm.init("col1", AttrType::INTS, 0, 4, true, 0,true);
...
TEST_P(PaxPageHandlerTestWithParam, DISABLED_PaxPageHandler)
{
  ...
  fm1.init("col1", AttrType::INTS, 0, 4, true, 0,true);
  fm2.init("col2", AttrType::FLOATS, 4, 4, true, 1,true);
  fm3.init("col3", AttrType::CHARS, 8, 4, true, 2,true);
  fm4.init("col4", AttrType::CHARS, 12, 7, true, 3,true);
  ...
  Chunk     chunk2;
  FieldMeta fm2_1;
  fm2_1.init("col2", AttrType::FLOATS, 4, 4, true, 1,true);
